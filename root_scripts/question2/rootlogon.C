void rootlogon() {
  ...
  gROOT->ProcessLine(".L tempTrender2.cpp+"); //Load the classes that we want to use automatically - Convenient!
  gROOT->ProcessLine(".L project2.cpp+"); //The + means to recompile only if it changed sine last time
